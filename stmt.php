...
<head>
	...
	<?php include_once("admin/includes/head_scripts.php"); ?>
                ...
                <ul class="nav navbar-nav navbar-nav-margin-left">
                    ...
                    <li class="dropdown active">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li class="active"><a href="website-instructor-statement.html">Statement</a></li>
        ...
        <div class="container parallax-layer" data-opacity="true">
            <div class="media v-middle">
                <div class="media-left text-center">
                    <a href="#"><img src="images/guy-1.jpg" alt="people" class="img-circle width-80"/></a>
                </div>
    ...
    <div class="container">
        ...
        <div class="table-responsive">
            <table class="table text-subhead v-middle">
                ...
                <tbody>
                <tr>
                    <td><div class="label label-grey-200">12 Jan 2015</div></td>
                    <td>Adrian Demian</td>
                    <td class="text-center"><a href="#">#3381</a></td>
                    <td class="text-center">&dollar;31</td>
                </tr>
                <tr>
                    <td><div class="label label-grey-200">12 Jan 2015</div></td>
                    <td>Adrian Demian</td>
                    <td class="text-center"><a href="#">#2029</a></td>
                    <td class="width-50 text-center">&dollar;47</td>
                </tr>
                <tr>
                    <td><div class="label label-grey-200">12 Jan 2015</div></td>
                    <td>Adrian Demian</td>
                    <td class="text-center"><a href="#">#5814</a></td>
                    <td class="text-center">&dollar;42</td>
                </tr>
                <tr>
                    <td><div class="label label-grey-200">12 Jan 2015</div></td>
                    <td>Adrian Demian</td>
                    <td class="text-center"><a href="#">#14072</a></td>
                    <td class="text-center">&dollar;93</td>
                </tr>
                <tr>
                    <td><div class="label label-grey-200">12 Jan 2015</div></td>
                    <td>Adrian Demian</td>
                    <td class="text-center"><a href="#">#4484</a></td>
                    <td class="text-center">&dollar;31</td>
                </tr>
                <tr>
                    <td><div class="label label-grey-200">12 Jan 2015</div></td>
                    <td>Adrian Demian</td>
                    <td class="text-center"><a href="#">#13506</a></td>
                    <td class="width-50 text-center">&dollar;81</td>
                </tr>
                <tr>
                    <td><div class="label label-grey-200">12 Jan 2015</div></td>
                    <td>Adrian Demian</td>
                    <td class="text-center"><a href="#">#14487</a></td>
                    <td class="text-center">&dollar;55</td>
                </tr>
                <tr>
                    <td><div class="label label-grey-200">12 Jan 2015</div></td>
                    <td>Adrian Demian</td>
                    <td class="text-center"><a href="#">#13742</a></td>
                    <td class="text-center">&dollar;90</td>
                </tr>
                </tbody>
            </table>
        </div>
