<?php 
	...
	$page_title = "Manage Subject Score Grades";
	
	$db = new DbHandler(); 
		
	$show_table = true;
	$show_grading_list = true;
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="tabbable paper-shadow relative" data-z="0.5">
                                    ...
                                    <ul class="nav nav-tabs">
                                        <li class="active"><a href="#item_listing" data-toggle="tab"><i class="fa fa-fw fa-bars"></i> <span class="hidden-sm hidden-xs">Subject Score Grades Listing</span></a></li>
                                        <li><a href="#new_item" data-toggle="tab"><i class="fa fa-fw fa-plus"></i> <span class="hidden-sm hidden-xs">Add Subject Score Grade</span></a></li>
                                    </ul>
                                    <!-- // END Tabs -->
                                    ...
                                    <div class="tab-content">
                                                        ...
                                                        <table class="table table-condensed table-hover text-subhead v-middle" id="mybootgrid">
                                                            <thead>
                                                                <tr>
                                                                    ...
                                                                    <th data-column-id="min" data-sortable="true">Min</th>
                                                                    <th data-column-id="max" data-sortable="true">Max</th>
                                        ...
                                        <div id="new_item" class="tab-pane">
                                            ...
                                            <div class="panel panel-default text-center login-form-bg" data-z="0.5">
                                                <h3 class="text-display-1 text-center margin-bottom-none">Add Subject Score Grade</h3>
                                                <hr>
                                                <div class="panel-body">
                                                    
                                                    <form class="form-add-score-grade inputform padding-no-top-20" data-parsley-validate>
                                                      
                                                        <div class="form-group">
                                                            <div class="row">
                                                                <label for="min" class="col-sm-5 control-label text-right">Min</label>
                                                                <div class="col-sm-7">
                                                        ...
                                                        <div class="form-group">
                                                            <div class="row">
                                                                <label for="max" class="col-sm-5 control-label text-right">Max</label>
                                                                <div class="col-sm-7">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="tabbable paper-shadow relative" data-z="0.5">
                                    ...
                                    <!-- Tabs -->
                                    <ul class="nav nav-tabs">
                                        <li class="active"><a href="#details" data-toggle="tab"><i class="fa fa-fw fa-bars"></i> <span class="hidden-sm hidden-xs">Subject Score Grade Details</span></a></li>
                                        <li><a href="#item-history" data-toggle="tab"><i class="fa fa-fw fa-bars"></i> <span class="hidden-sm hidden-xs">Subject Score Grade History</span></a></li>
                                    </ul>
                                    <!-- // END Tabs -->
                                    ...
                                    <div class="tab-content">
                                        ...
                                        <div class="no-results">Please Select Score Grade to Begin</div>
                                        ...
                                        <div id="details" class="tab-pane active">
                                            ...
                                            <div class="item-details hidden">
                                                ...
                                                <div class="panel panel-default text-center login-form-bg" data-z="0.5">
                                                    <h3 class="text-display-1 text-center margin-bottom-none">Edit Subject Score</h3>
                                                    <hr>
                                                    <div class="panel-body">
                                                        
                                                        <form class="form-horizontal form-edit-score-grade">
