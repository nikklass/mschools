...
<!-- <link href="<?=SITEPATH?>css/all.css" rel="stylesheet"> -->
    ...
    <link href="<?=SITEPATH?>css/bootstrap.css" rel="stylesheet">
            <link href="<?=SITEPATH?>css/font-awesome.css" rel="stylesheet">
            <link href="<?=SITEPATH?>css/picto.css" rel="stylesheet">
            <link href="<?=SITEPATH?>css/material-design-iconic-font.css" rel="stylesheet">
            <link href="<?=SITEPATH?>css/datepicker3.css" rel="stylesheet">
            <link href="<?=SITEPATH?>css/jquery.minicolors.css" rel="stylesheet">
            <link href="<?=SITEPATH?>css/railscasts.css" rel="stylesheet">
            <link href="<?=SITEPATH?>css/owl.carousel.css" rel="stylesheet">
            <link href="<?=SITEPATH?>css/slick.css" rel="stylesheet">
            <link href="<?=SITEPATH?>css/daterangepicker-bs3.css" rel="stylesheet">
            <link href="<?=SITEPATH?>css/jquery.bootstrap-touchspin.css" rel="stylesheet">
            <link href="<?=SITEPATH?>css/select2.css" rel="stylesheet">
            <link href="<?=SITEPATH?>css/jquery.countdown.css" rel="stylesheet">
    ...
    <div class="container-fluid">
        <div class="navbar-header">
            ...
            <div class="navbar-brand navbar-brand-primary navbar-brand-logo navbar-nav-padding-left">
                <a class="svg" href="app-student-dashboard.html"><svg viewBox="0 0 106 64" height="100%" width="100%" preserveAspectRatio="xMidYMid meet">
...
<p class="text-light"><span class="caption">Course:</span> <a href="app-student-course.html">Basics Of HTML</a></p></li>
	...
	<div class="media-body">
		<p class="text-subhead">
			<a href="#"><img src="images/people/110/guy-5.jpg" alt="person" class="width-30 img-circle"/></a> &nbsp;
            <a href="#">mosaicpro</a>
