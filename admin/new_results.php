...
<?php 
	...
	if (!(HAS_CREATE_RESULT_PERMISSION || SCHOOL_ADMIN_USER)) 
	{
                        ...
                        <div class=" col-md-12">
                            ...
                            <div class="tabbable paper-shadow relative" data-z="0.5">
                                ...
                                <ul class="nav nav-tabs">
                                    <li class="active"><a href="#bulk" data-toggle="tab"><i class="fa fa-fw fa-credit-card"></i> 
                                    	<span class="hidden-sm hidden-xs">Add Bulk Student Results</span></a>
                                    </li>
                                </ul>
                                <!-- // END Tabs -->
                                    ...
                                    <div id="bulk" class="tab-pane active">
                                        ...
                                        <form enctype="multipart/form-data" method="post" class="form-upload-results">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-9">
                                                	<div class="padding-20"><i class="fa fa-2x fa-file-excel-o text-success"></i> &nbsp;&nbsp;<a href="<?=SITEPATH?>sample_files/results_upload.csv">Excel Data Upload Template (CLICK to download)</a></div>
                                                </div>
                                            </div>
                                            <hr>
                                            <div class="form-group">
