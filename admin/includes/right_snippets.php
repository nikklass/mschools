<div class="panel panel-default" data-toggle="panel-collapse" data-open="true">
    ...
    <div class="panel-body list-group">
        <ul class="list-group list-group-menu">
            ...
            <li class="list-group-item"><a class="link-text-color" href="website-student-courses.html">School Fees</a></li>
            <li class="list-group-item"><a class="link-text-color" href="website-student-profile.html">School Results</a></li>
