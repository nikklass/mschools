                ...
                <div class="col-sm-4 col-sm-offset-4">
                    <div class="panel panel-default text-center login-form-bg" data-z="0.5">
                        ...
                        <div class="panel-body">
                            ...
                            <form class="form-horizontal form-signin inputform padding-20-all" data-parsley-validate>
                                ...
                                <div class="form-group">
                                    <div class="row">
                                        <label for="phone_number">Email/ Phone No</label>
                                        <input class="form-control text-center" id="phone_number" name="phone_number" type="text" data-parsley-trigger="change focusout" data-parsley-required required>
                                ...
                                <div class="form-group">
                                    <div class="row">
                                        ...
                                        <input class="form-control text-center" id="password" name="password" type="password" data-parsley-trigger="change focusout" data-parsley-required required>
