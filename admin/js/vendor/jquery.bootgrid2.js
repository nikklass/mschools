 ...
 * 
 * !!! THIS SCRIPT IS CHANGED BY CEAG !!!
 * 
 */
;(function ($, window, undefined)
{
    ...
    */
        ...
        if (this.options.navigation !== 0)
        {
            ...
            if (searchItems.length > 0)
            {
                ...
                searchField.on("keyup" + namespace, function (e)
                {
                    ...
                    if (currentValue !== newValue || (e.which === 13 && newValue !== "") || e.which === 46) // 13 = Enter, 46 = Del
                    {
     ...
     * @param [page] {Number} The page index to be set.
     * @since 08.03.2016
     */
    Grid.prototype.setCurrentPage = function (page) {
        this.current = page;
    };
    ...
    /**
     * Sets the column sorting.
     * This method was added by CEAG and is not part of the original code.
     * 
     * @method setSortDictionary
     * @param [sortField] {String} The field to be sorted by.
     * @param [sortDirection] {String} The direction to be sorted by (Ascending / Descending).
     * @since 08.03.2016
     */
    Grid.prototype.setSortDictionary = function (sortField, sortDirection) {
        var dictionary = {};
        dictionary[sortField] = sortDirection == "Ascending" ? "asc" : "desc";
