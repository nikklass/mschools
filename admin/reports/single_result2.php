...
<html>
   ...
   <?php
    ...
    <table width="100%" cellpadding="2" class="table table-striped">
            ...
            <tr>
                <td width="40%" align="left"><strong>Subject</strong></td>
                <td width="30%" align="right"><strong>Score</strong></td>
                <td width="30%" align="right"><strong>Grade</strong></td>
            </tr>
